...
class Config(object):
	...
	SECRET_KEY = os.environ.get("SECRET_KEY") or "K:},y]yogU4j}ep40+yK" # hard coded secret key -> do not use for production
	...
	# settings
	JOB_TIMEOUT = 10*60 # maximum of 10 minutes for a job to complete